...
class PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post preferences_url, params: { preference: { height: @preference.height, pet: @preference.pet, weight: @preference.weight } }
    end
  ...
  test "should update preference" do
    patch preference_url(@preference), params: { preference: { height: @preference.height, pet: @preference.pet, weight: @preference.weight } }
